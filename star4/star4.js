...
function draw() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        let hue = random(160); // Random hue for color variation (used for our HSB)
        
        fill(hue, 80, 200); // Set fill color with random hue and some saturation and brightness
    ...
    background(0, 0, 0, 5); // Black background with low opacity to create a fading effect
}
