...
function draw() {
    ...
    if (frameCount % 60 === 0) {
        ...
        fill(random(50,150), random(100,200), random(100,155));    // text colour white
    ...
    for (let y = 0; y < height; y += 9) {
        fill(255, 255, 20, random(0,80)); // Yellow with varying transparency
        rect(0, y, width, random(5,20)); // Full width, random height
    }
    ...
    for (let i = 0; i < 15; i++) {
        ...
        let alpha = random(0, 20);  // Very transparent
