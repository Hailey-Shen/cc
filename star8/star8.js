...
function draw() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        let r = random(0.2, 10); // Random radius for the star, smaller values for more distant stars
      
        fill(random(255),random(255),random(255)); // Set fill color with random hue and some saturation and brightness
