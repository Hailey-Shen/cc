...
function draw() {
  ...
  push();
    ...
    fill(235, 0, 0); // give the floor its colour
  ...
  push();
    ...
    translate(-240, -40, 0); // Move the box up off the floor and into the scene a bit
    noStroke();
    ...
    box(100); // A cube — one argument means all sides are equal length
